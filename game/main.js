...
import { TIERS, detectTier, getTier, applyTierToRenderer } from './src/render/quality.js?v=r24-202608300022';
import { createLightingRig, SUN_COLOR, SKY_COLOR, SUN_INTENSITY, SKY_INTENSITY, sunDirection } from './src/render/lighting.js?v=r24-202608300022';
import { createSky } from './src/render/sky.js?v=r24-202608300022';
import { createPost } from './src/render/post.js?v=r24-202608300022';
import { TERRAIN_SPEC, buildTerrain } from './src/world/terrain.js?v=r24-202608300022';
import { createSkirt } from './src/world/skirt.js?v=r24-202608300022';   // round 17 item 5: ground beyond the map edge
import { createFarBand } from './src/level/farband.js?v=r24-202608300022';   // round 24: oilfield landmarks at 150 to 400 m
import { World } from './src/world/collision.js?v=r24-202608300022';
import { buildLevel } from './src/level/build.js?v=r24-202608300022';
import { PLACEMENTS, LINKS, WALKABLES, SPAWNS, COVER_POINTS, BOUNDARY } from './src/level/placements.js?v=r24-202608300022';
import { Player } from './src/player/controller.js?v=r24-202608300022';
import { WeaponSystem, WEAPONS } from './src/player/weapons.js?v=r24-202608300022';
import { Viewmodel } from './src/player/viewmodel.js?v=r24-202608300022';
import { FX } from './src/player/fx.js?v=r24-202608300022';
import { NavGrid } from './src/ai/navgrid.js?v=r24-202608300022';
import { Bot } from './src/ai/bot.js?v=r24-202608300022';
import { SquadManager } from './src/ai/squad.js?v=r24-202608300022';
import { Input, RAD_PER_PX } from './src/ui/input.js?v=r24-202608300022';
import { TouchControls } from './src/ui/touch.js?v=r24-202608300022';
import { HUD } from './src/ui/hud.js?v=r24-202608300022';
import { Screens } from './src/ui/screens.js?v=r24-202608300022';
import { Events } from './src/game/events.js?v=r24-202608300022';
import { TDM } from './src/game/mode.js?v=r24-202608300022';
import { createTelemetry } from './src/game/telemetry.js?v=r24-202608300022';
import { Audio } from './src/game/audio.js?v=r24-202608300022';
import { ASSET } from './assetlib.js?v=r24-202608300022';
import { vertexiseMaterials } from './src/game/bake.js?v=r24-202608300022';
import { preloadMaterials, applyTerrainMaterial, applyMaterials } from './src/render/materials.js?v=r24-202608300022';   // materials r3
