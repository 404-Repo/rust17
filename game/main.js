...
import { TIERS, detectTier, getTier, applyTierToRenderer } from './src/render/quality.js?v=r22-202608292151';
import { createLightingRig, SUN_COLOR, SKY_COLOR, SUN_INTENSITY, SKY_INTENSITY, sunDirection } from './src/render/lighting.js?v=r22-202608292151';
import { createSky } from './src/render/sky.js?v=r22-202608292151';
import { createPost } from './src/render/post.js?v=r22-202608292151';
import { TERRAIN_SPEC, buildTerrain } from './src/world/terrain.js?v=r22-202608292151';
import { createSkirt } from './src/world/skirt.js?v=r22-202608292151';   // round 17 item 5: ground beyond the map edge
import { World } from './src/world/collision.js?v=r22-202608292151';
import { buildLevel } from './src/level/build.js?v=r22-202608292151';
import { PLACEMENTS, LINKS, WALKABLES, SPAWNS, COVER_POINTS, BOUNDARY } from './src/level/placements.js?v=r22-202608292151';
import { Player } from './src/player/controller.js?v=r22-202608292151';
import { WeaponSystem, WEAPONS } from './src/player/weapons.js?v=r22-202608292151';
import { Viewmodel } from './src/player/viewmodel.js?v=r22-202608292151';
import { FX } from './src/player/fx.js?v=r22-202608292151';
import { NavGrid } from './src/ai/navgrid.js?v=r22-202608292151';
import { Bot } from './src/ai/bot.js?v=r22-202608292151';
import { SquadManager } from './src/ai/squad.js?v=r22-202608292151';
import { Input, RAD_PER_PX } from './src/ui/input.js?v=r22-202608292151';
import { TouchControls } from './src/ui/touch.js?v=r22-202608292151';
import { HUD } from './src/ui/hud.js?v=r22-202608292151';
import { Screens } from './src/ui/screens.js?v=r22-202608292151';
import { Events } from './src/game/events.js?v=r22-202608292151';
import { TDM } from './src/game/mode.js?v=r22-202608292151';
import { createTelemetry } from './src/game/telemetry.js?v=r22-202608292151';
import { Audio } from './src/game/audio.js?v=r22-202608292151';
import { ASSET } from './assetlib.js?v=r22-202608292151';
import { vertexiseMaterials } from './src/game/bake.js?v=r22-202608292151';
import { preloadMaterials, applyTerrainMaterial, applyMaterials } from './src/render/materials.js?v=r22-202608292151';   // materials r3
