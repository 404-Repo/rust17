...
import { TIERS, detectTier, getTier, applyTierToRenderer } from './src/render/quality.js?v=r16-202608291520';
import { createLightingRig, SUN_COLOR, SKY_COLOR, SUN_INTENSITY, SKY_INTENSITY, sunDirection } from './src/render/lighting.js?v=r16-202608291520';
import { createSky } from './src/render/sky.js?v=r16-202608291520';
import { createPost } from './src/render/post.js?v=r16-202608291520';
import { TERRAIN_SPEC, buildTerrain } from './src/world/terrain.js?v=r16-202608291520';
import { World } from './src/world/collision.js?v=r16-202608291520';
import { buildLevel } from './src/level/build.js?v=r16-202608291520';
import { PLACEMENTS, LINKS, WALKABLES, SPAWNS, COVER_POINTS, BOUNDARY } from './src/level/placements.js?v=r16-202608291520';
import { Player } from './src/player/controller.js?v=r16-202608291520';
import { WeaponSystem, WEAPONS } from './src/player/weapons.js?v=r16-202608291520';
import { Viewmodel } from './src/player/viewmodel.js?v=r16-202608291520';
import { FX } from './src/player/fx.js?v=r16-202608291520';
import { NavGrid } from './src/ai/navgrid.js?v=r16-202608291520';
import { Bot } from './src/ai/bot.js?v=r16-202608291520';
import { SquadManager } from './src/ai/squad.js?v=r16-202608291520';
import { Input, RAD_PER_PX } from './src/ui/input.js?v=r16-202608291520';
import { TouchControls } from './src/ui/touch.js?v=r16-202608291520';
import { HUD } from './src/ui/hud.js?v=r16-202608291520';
import { Screens } from './src/ui/screens.js?v=r16-202608291520';
import { Events } from './src/game/events.js?v=r16-202608291520';
import { TDM } from './src/game/mode.js?v=r16-202608291520';
import { createTelemetry } from './src/game/telemetry.js?v=r16-202608291520';
import { Audio } from './src/game/audio.js?v=r16-202608291520';
import { ASSET } from './assetlib.js?v=r16-202608291520';
import { vertexiseMaterials } from './src/game/bake.js?v=r16-202608291520';
import { preloadMaterials, applyTerrainMaterial } from './src/render/materials.js?v=r16-202608291520';   // materials r3
