...
import { VertexPBRMaterial, vertexiseMaterials } from '../game/bake.js?v=r22-202608292135';
import { classify, RECIPES } from '../../surfaces.js?v=r22-202608292135';
import { sunDirection, SUN_COLOR, SUN_INTENSITY } from './lighting.js?v=r22-202608292135';   // round 5: the cards' backlight reads the rig's sun
