...
import { VertexPBRMaterial, vertexiseMaterials } from '../game/bake.js?v=r19-202608291944';
import { classify, RECIPES } from '../../surfaces.js?v=r19-202608291944';
import { sunDirection, SUN_COLOR, SUN_INTENSITY } from './lighting.js?v=r19-202608291944';   // round 5: the cards' backlight reads the rig's sun
