...
import { VertexPBRMaterial, vertexiseMaterials } from '../game/bake.js?v=r21-202608292011';
import { classify, RECIPES } from '../../surfaces.js?v=r21-202608292011';
import { sunDirection, SUN_COLOR, SUN_INTENSITY } from './lighting.js?v=r21-202608292011';   // round 5: the cards' backlight reads the rig's sun
