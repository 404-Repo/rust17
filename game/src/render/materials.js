...
import { VertexPBRMaterial, vertexiseMaterials } from '../game/bake.js?v=r23-202608292320';
import { classify, RECIPES } from '../../surfaces.js?v=r23-202608292320';
import { sunDirection, SUN_COLOR, SUN_INTENSITY } from './lighting.js?v=r23-202608292320';   // round 5: the cards' backlight reads the rig's sun
