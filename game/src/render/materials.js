...
import { VertexPBRMaterial, vertexiseMaterials } from '../game/bake.js?v=r10-202608291000';
import { classify, RECIPES } from '../../surfaces.js?v=r10-202608291000';
import { sunDirection, SUN_COLOR, SUN_INTENSITY } from './lighting.js?v=r10-202608291000';   // round 5: the cards' backlight reads the rig's sun
