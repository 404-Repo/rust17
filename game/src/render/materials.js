...
import { VertexPBRMaterial, vertexiseMaterials } from '../game/bake.js?v=r24-202608300022';
import { classify, RECIPES } from '../../surfaces.js?v=r24-202608300022';
import { sunDirection, SUN_COLOR, SUN_INTENSITY } from './lighting.js?v=r24-202608300022';   // round 5: the cards' backlight reads the rig's sun
