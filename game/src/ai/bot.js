...
import { loadGlbSoldier } from './glbsoldier.js?v=r22-202608292253';
import { applyTeamLook, attachTeamMarks, teamLookEnabled } from './teamlook.js?v=r22-202608292253';   // round 10: abstract team colour figures   // round 8: skinned soldiers from Atlas (Titan v1 + rig_humanoid_mesh)
import { SoldierRig } from './animation.js?v=r22-202608292253';
