...
import { ASSET, preloadAssets, bakeStatic, assetSize } from '../../assetlib.js?v=r22-202608292124';
import { PLACEMENTS, LINKS, WALKABLES, INTERIORS, SIGHTLINES, PADS, padAt } from './placements.js?v=r22-202608292124';
import { GLB_STATIC, loadGlbStatic } from './glbstatic.js?v=r22-202608292124';   // round 11: Atlas rocks
import { applyMaterials } from '../render/materials.js?v=r22-202608292124';   // materials r3: triplanar PBR sets, wraps vertexiseMaterials
import { collapsePerJoint } from '../ai/animation.js?v=r22-202608292124';
import { buildDecals } from '../render/decals.js?v=r22-202608292124';   // decals r6: near field decals, built after the bake
import { FILLET_ASSETS, makeFillet } from './fillets.js?v=r22-202608292124';   // round 17 item 1: contact fillets
