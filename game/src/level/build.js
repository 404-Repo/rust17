...
import { ASSET, preloadAssets, bakeStatic, assetSize } from '../../assetlib.js?v=r23-202608292320';
import { PLACEMENTS, LINKS, WALKABLES, INTERIORS, SIGHTLINES, PADS, padAt } from './placements.js?v=r23-202608292320';
import { GLB_STATIC, loadGlbStatic } from './glbstatic.js?v=r23-202608292320';   // round 11: Atlas rocks
import { applyMaterials } from '../render/materials.js?v=r23-202608292320';   // materials r3: triplanar PBR sets, wraps vertexiseMaterials
import { collapsePerJoint } from '../ai/animation.js?v=r23-202608292320';
import { buildDecals } from '../render/decals.js?v=r23-202608292320';   // decals r6: near field decals, built after the bake
import { FILLET_ASSETS, makeFillet, STILT_ASSETS, makeStiltsFromObject } from './fillets.js?v=r23-202608292320';   // round 17: contact fillets; round 22i: stilts
